...
$user_id = $_GET['id'];
$getid = "select * from `products` where pid ='$user_id'";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="justify-content-center">
                ...
                <input type="hidden" name="id" class="form-control" value="<?php echo $rows['pid'] ?>">
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    ...
                    <textarea name="pdesc" class="form-control col-md-12" placeholder="Leave a comment here" id="floatingTextarea"><?php echo $rows['pdescription'] ?></textarea>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="file" name="pimage" class="form-control" value="<?php echo $rows['image'] ?>">
                </div>
