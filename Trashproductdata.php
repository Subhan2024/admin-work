...
$fetching_pro = "SELECT * from products as p INNER JOIN category as c on p.pcategory = c.id where pstatus ='0'";
            ...
            <tbody>
                ...
                while ($pro_data = mysqli_fetch_assoc($pro_result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="restoreproducts.php?id=<?php echo $pro_data['pid']; ?>" class="btn btn-primary">Restore</a>
                        </td>
                        <td><a href="deleteproduct.php?id=<?php echo $pro_data['pid']; ?>" class="btn btn-danger">Delete</a>
                        </td>
