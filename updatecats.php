            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-10 col-lg-12 col-md-9">
                        ...
                        <hr>
                        <form class="user" action="updatedetailscats.php" method="POST">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea"
                                    name="des"><?php echo $rows['des'] ?></textarea>
                            </div>
                            <br>
                            <input type="submit" class="btn btn-primary btn-user btn-block" name="Cat">
