...
$fetch = "SELECT * FROM `products` where pstatus = '1' ";
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"></span> <span>Menu</span></p>
            </div>
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
		                <div class="row">
		              		<div class="col-md-4 col-sm- col-lg- text-center">
		              			<div class="menu-wrap">
	...
	<?php
        ...
        $query = mysqli_query($connection, $fetchpage);
          ...
          if(mysqli_num_rows($query) > 0){
            ...
            if($getpgno > 1){
              echo '<li class="page-item"><a class="page-link" href="menu.php?page='.($getpgno - 1).'">prev</a></li>';

            }
            for($i = 1; $i <= $totalpages; $i++){
              $active = $i == $getpgno? "active" : "";
              echo '<li class="'.$active.' page-item"><a class="page-link" href="menu.php?page='.$i.'">'.$i.'</a></li>';
            }
            if($getpgno < $totalpages){
              echo '<li class="page-item"><a class="page-link" href="menu.php?page='.($getpgno + 1).'">next</a></li>';
